...
INSERT INTO stories (epic, id, title, status, dod, consumes, produces, blocked) VALUES ('v0-bootstrap', 'S19', 'S12 - pilot ladder and remaining deliverables', 'PLANNED', 'pilot rungs 3-4; README; CONTRIBUTING (DCO + AI clause); generic migration guide (INV-449/450 ride here); docs link-check', '', '', '');
