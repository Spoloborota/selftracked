-- selftracked dump schema_version=1 tasks=14 artifacts=0
...
INSERT INTO epic_criteria (epic, seq, criterion, met, evidence) VALUES ('v0-bootstrap', 1, 'Verb catalog, integrity engine (R1-R15), init, hooks, reader half, and import built; make gates green locally through S9', 1, 'git history: docs/v0-progress.md ledger @ 850b2f2; local gates run @ ce68f30 (interim, D-EP8)');
INSERT INTO epic_criteria (epic, seq, criterion, met, evidence) VALUES ('v0-bootstrap', 2, '$ selftracked verify', 1, 'PASS selftracked verify @ 2026-07-23T22:28:38Z');
INSERT INTO epic_criteria (epic, seq, criterion, met, evidence) VALUES ('v0-bootstrap', 3, 'Schema version gate and migration branches ship (plan S11)', 1, 'S11 landed at commits 84d5ede..cb0d313: the 8.6 gate before every verb (dispatcher + pipeline re-check), the migration engine on the load path with two hydration sources, escalation with the sentinel protocol, 8.4 branches (5)-(6), prime migrated:vK->vN; make gates exit 0 on a cleared cache 2026-07-24; FULL three-critic close review; spec revs 3.22-3.23');
...
INSERT INTO epic_criteria (epic, seq, criterion, met, evidence) VALUES ('v0-bootstrap', 7, 'Spec governed proposal-first end to end: every deviation an archived amendment (26 amendments through spec rev 3.21 / plan rev 17)', 1, 'openspec/changes/ directory; amendments log in git history (docs/v0-progress.md @ 23cc8bf)');
...
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (5, 'First push: re-run gates on the squashed tree and re-stamp every verified row (D-EP11)', 'OPEN', 'The publication boundary. Prepared 2026-07-24: gates exit 0 on a CLEAN CHECKOUT of HEAD (the run caught and fixed the golden-eaten-by-gitignore trap); history swept for client/email/machine-path leaks (0 hits over 104 commits); squash message must stay free of client-derived facts incl. aggregate counts. THE FORK (owner): D-EP11 prescribed a squash, but post-S10 the tracker''s worklog cites 21 distinct shas - a squash breaks R5 on every fresh clone of the published repo; full-history publish keeps R5 green and D-EP11''s re-stamp becomes vacuous. Remaining after the owner''s choice+push: CI green, then flip criterion 6 with the CI run as evidence.', '', NULL, 'v0-bootstrap', '2026-07-23T22:09:23Z', '2026-07-24T02:03:51Z');
...
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (12, 'PROMPT.md verb catalog omits gate and import; verify the deny-list claim''s wording against the live instance', 'NEEDS-TRIAGE', 'Pre-publication audit (2026-07-24) findings on the generated PROMPT.md: (a) the verb catalog lists 25 of 27 verbs - gate and import are absent though both are real (binary --help is authoritative); (b) PROMPT.md states the generated .claude/settings.json carries a sqlite3 deny entry - true for the scaffold template, but this repo''s own dogfooded settings.json had drifted (no permissions block until fixed 2026-07-24). Fix belongs in the doc generator, so the correction reaches every adopter; check the golden testdata rides along.', '', NULL, NULL, '2026-07-24T13:01:13Z', '2026-07-24T13:01:13Z');
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (13, 'Harden the agent push barrier; decide template propagation and credential isolation', 'NEEDS-TRIAGE', 'OWNER DECISION 2026-07-24 (recorded in English by meaning): decision (A) resolved - keep the git-push deny in THIS repository''s .claude/settings.json only; do NOT propagate to the scaffold template. Adopters decide for themselves whether they want it, so no product-surface change and no amendment is needed. The deny is in place and committed. Decision (B), credential isolation as the only true wall, remains owner-optional and un-taken; parking the task since the requested (A) work is complete.', 'Requested work (A) complete: push-deny lives in this repo only, no template change; (B) credential isolation remains owner-optional', NULL, NULL, '2026-07-24T13:26:03Z', '2026-07-24T13:32:43Z');
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (14, 'History rewrite plan (variant alpha) — execute before the first public push', 'NEEDS-TRIAGE', 'Pre-first-push history rewrite via git-filter-repo, on a backup clone, owner-gated. Purge list: (1) replace-text the two Cyrillic owner-quote fragments across all blobs (they live in commit ea6abf4, unreachable by a HEAD edit); (2) OPTIONAL scrub the aggregate pilot-corpus counts from commit 3d32c690''s message; (3) purge the stray file test_sha_fallback.sh from ALL history via --path --invert-paths (removed from HEAD, still in history since dfe7daf); (4) OPTIONAL normalize author/committer timezones +0300 -> +0000 (hides region label; work-hour rhythm and the already-public root commit still leak). Cascade: rewriting ea6abf4 (pos 10 of ~111) changes ~102 downstream SHAs; 18 of 21 tracker-cited worklog SHAs break -> re-stamp via ''worklog add --corrects'' (the D-EP11 re-stamp mechanism), and update ~25 prose SHA citations in docs/openspec via the commit map. Then full ''make gates'' + ''verify'' on the rewritten clone before any push. Alternatives already weighed: (beta) squash destroys all evidence SHAs unrecoverably - worse; (gamma) accept residuals - owner declined for the sensitive items. Recorded 2026-07-24; leave check-inventory.py in place (documented deliberate keep, not debris).', 'Executes only at the owner''s go, immediately before the first public push; not v0-blocking', NULL, NULL, '2026-07-24T14:21:47Z', '2026-07-24T14:21:47Z');
...
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 1, 'S1', '2026-07-18T23:39:52Z', 'DONE', '7633f8f', 'python3 scripts/check-inventory.py exit 0', '', NULL, '545 obligations extracted from the spec and ratified as the control artifact (D-EP4); three review passes; governance amendments plan-accounting-scope and stage-open-plan-crosscheck filed at close (plan revs 5-6).');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 2, 'S2', '2026-07-18T23:59:39Z', 'DONE', 'e09204a', 'make gates exit 0 (local, D-EP8)', '', NULL, 'Repo bootstrap: Makefile gates chain, check-inventory, probe scripts. Close review found two fail-open probes (reported success without go on PATH) - both refuse now. Amendments review-proportionality-tiers, local-commits-and-interim-evidence, s0-minimal-package, split-s1 (plan revs 7-10).');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 3, 'S3', '2026-07-19T07:21:29Z', 'DONE', '6cf73a1', 'make gates exit 0 (local, D-EP8)', '', NULL, 'Schema as text + connection posture. Close found the DSN setting the one journal mode the spec rules out, and proved the DDL tests could not fail by deleting a trigger. Amendment nullable-columns-preamble - the first to the specification (spec rev 3.10).');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 4, 'S4', '2026-07-19T10:30:12Z', 'DONE', 'ad8ef15', 'make gates exit 0, 114 subtests, -race, fresh cache', '', NULL, 'Schema gates; first stage under the D-EP13 opening record. Five mutation probes shown red. Amendments worklog-story-guard-rule-pointer (spec rev 3.12) and epic-close-story-cardinality (3.13); the governance trio stage-open-record, evidence-across-a-squash, pre-authorized-amendment-cadence landed this window (plan revs 11-13).');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 5, 'S5', '2026-07-19T10:45:04Z', 'DONE', 'e5b2006', 'make gates exit 0 (local, D-EP8)', '', NULL, 'Driver behaviour: Serialize byte-identity, pragma posture, the _dqs=0 probe. One accepted fix: an unchecked type assertion made uniform with its siblings.');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 6, 'S6', '2026-07-19T11:10:50Z', 'DONE', '739f8c9', 'make gates exit 0 (local, D-EP8)', '', NULL, 'CLI dispatcher: closed verb set, section 3.2 flag posture. The bare word help - scope never granted - was deleted outright, dissolving the verb-shadowing it had silently created.');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 7, 'S7', '2026-07-19T11:32:05Z', 'DONE', 'd20ecf1', 'make gates exit 0 (local, D-EP8)', '', NULL, 'Deterministic serializer + dump. The mutation story: two probes struck as no-ops (green against an unmutated file proves nothing), an ORDER BY removal surviving black-box fixtures killed by a white-box guard, and the critic proved a second surviving mutant (duplicated DDL block) the same way.');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 8, 'S8', '2026-07-19T19:30:39Z', 'DONE', '4ee8f22', 'make gates exit 0 (local, D-EP8)', '', NULL, 'load + whitelist-parser fuzzing - the security boundary. Adversarial close weighted parser bypass hardest and found none; the statement-boundary attack round-trips as one literal, hand-verified. Amendment import-date-bounds (spec rev 3.11) had already sharpened the import obligations this stage''s parser serves.');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 9, 'S9', '2026-07-19T20:18:49Z', 'DONE', '0699fba', 'make gates exit 0 (local, D-EP8)', '', NULL, 'Task-lifecycle verbs and the write pipeline. Close critic hand-drove the binary: five resolved-but-unfixtured rows and a latent section 6.1 order inversion (sidecar before STATE.md slot) - all fixed before any row flipped.');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 10, 'S10', '2026-07-19T21:19:54Z', 'DONE', 'b051a2a', 'make gates exit 0 (local, D-EP8)', '', NULL, 'Relation/artifact/dictionary verbs. Four blockers fixed pre-flip: symlink containment escape, root-move nesting corruption, --with-files zero coverage, untested epic-link path. Amendments link-tables-are-relations-not-history (spec rev 3.14) and instance-scoped-events-and-r8 (3.15) applied mid-stage.');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 11, 'S11', '2026-07-19T21:57:54Z', 'DONE', '551bb98', 'make gates exit 0 (local, D-EP8)', '', NULL, 'Epic/story/worklog/criteria verbs - the largest verb stage. Real INV-119 blocker (terminal re-transition duplicating worklog episodes) fixed via a source-guarded helper; invented scope (ready-requires-DoD) removed. Amendment dod-shape-is-authoring-convention (spec rev 3.16).');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 12, 'S12', '2026-07-20T09:03:56Z', 'DONE', 'fed963f', 'make gates exit 0 (local, D-EP8)', '', NULL, 'verify: R1-R15 with per-rule red fixtures and the mechanized coverage audit. R1 check 2 double-count fixed; R9/R10 tightened to the literal rules. The semantics critic found the set-status DUPLICATE poison pill (fixed 2026-07-23, pre-S10). Amendment r14-rides-its-renderer-at-s8c (plan rev 14).');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 13, 'S13', '2026-07-20T09:59:29Z', 'DONE', 'e15759f', 'make gates exit 0 (local, D-EP8)', '', NULL, 'init scaffold + generated docs. Two data-loss bugs caught by critics before the flip: init clobbering a clone''s tracked dump, and --force wiping the DB (now a refresh). The section 6.1 order inversion recreated via old WriteFiles - fixed the pipeline way.');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 14, 'S14', '2026-07-20T14:03:21Z', 'DONE', 'dfe7daf', 'make gates exit 0 (local, D-EP8)', '', NULL, 'Git hooks + the section 8.4 sidecar matrix. Six robustness defects fixed pre-flip, sharpest: os.WriteFile setting mode only on creation left a refreshed hook non-executable - git skips it silently. Amendments gate-skip-joins-the-r8-carve-out (spec rev 3.17) and prime-divergence-rides-prime-at-s8c (plan rev 15).');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 15, 'S15', '2026-07-20T18:12:57Z', 'DONE', 'c0d75c4', 'make gates exit 0 (local, D-EP8)', '', NULL, 'state, prime, SessionStart, R1 check 3. load must NOT regenerate STATE.md (would mask committed drift). Accepted fixes: reflective prose-scan, atomicWrite TOCTOU, fourth SessionStart branch, non-git stale degradation. Amendment migrated-field-rides-migration-at-s11 (plan rev 16).');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 16, 'S16', '2026-07-21T03:50:39Z', 'DONE', 'ce68f30', 'make gates exit 0 (local, D-EP8)', 'five fresh critics + verification re-critic; adjudication: docs/research/2026-07-21-s9-import-critic-round.md', NULL, 'import --legacy - the one sanctioned backfill door. Batch reader before the shared write pipeline in one transaction; git-first date engine (author dates, newest cited commit); deterministic per-epic source map; three relaxations gated exactly. Amendment import-guide-reviews-ride-to-s12 (plan rev 17).');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 17, 'S17', '2026-07-23T20:50:45Z', 'IN-PROGRESS', '850b2f2', '', '', NULL, 'Opened per D-EP13 (docs/stage-openings/s10.md). Pre-stage: the dup-chain poison pill fixed (b3cadcf); the 2026-07-24 open-questions round ran five critics on the fork analysis and the owner ratified four amendments (spec revs 3.18-3.21), applied and verified. This import is the switchover itself.');
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 18, 'S17', '2026-07-23T22:29:35Z', 'DONE', '850b2f2..69f1f48', 'make gates exit 0 (cleared cache, binary on PATH); selftracked verify full: 0 violations', 'Three-critic close round (plan obligations, corpus fidelity, mechanics re-run), findings adjudicated and applied. Erratum: epic criterion 7 says 26 amendments - the true count is 25 (openspec/changes/ has 25 directories; spec revs 3.10-3.21 = 12 plus plan revs 5-17 = 13), and criteria text is verb-immutable, so the correction lives here. The four 2026-07-24 amendments folded into the S17 record by name: paused-epic-sprint-goal-is-intended, load-prose-matches-load, rc-triage-verify-did-not-complete, backfill-parenthetical-names-its-relaxation.', NULL, '');
...
INSERT INTO worklog (epic, seq, story, date, state, commits, gate, review, corrects, note) VALUES ('v0-bootstrap', 22, 'S19', '2026-07-24T01:51:54Z', 'DONE', '84d5ede..672ad45', 'make gates exit 0; scripts/check-doc-links.sh exit 0; rehearsal rounds verify full 0 violations (archived); live client verify full 0 violations', 'FULL three-critic round (privacy, document fidelity, rehearsal mechanics); derivation defects found, fixed, rounds re-run and the live install redone pre-close; tasks #8-#10 filed; close appendix in docs/stage-openings/s12.md; public record docs/research/2026-07-24-pilot-import-rehearsal.md', NULL, '');
...
INSERT INTO events (seq, at, entity, event, detail) VALUES (11, '2026-07-23T22:29:35Z', 'epic:v0-bootstrap/S17', 'story', 'done: 850b2f2..69f1f48; gate: make gates exit 0 (cleared cache, binary on PATH); selftracked verify full: 0 violations');
...
INSERT INTO events (seq, at, entity, event, detail) VALUES (14, '2026-07-24T01:15:16Z', 'epic:v0-bootstrap/S18', 'story', 'done: 84d5ede..cb0d313; gate: make gates exit 0 on a cleared cache, 2026-07-24; full verify 0 violations on the live tracker under the gated binary');
...
INSERT INTO events (seq, at, entity, event, detail) VALUES (22, '2026-07-24T01:51:54Z', 'epic:v0-bootstrap/S19', 'story', 'done: 84d5ede..672ad45; gate: make gates exit 0; scripts/check-doc-links.sh exit 0; rehearsal rounds verify full 0 violations (archived); live client verify full 0 violations');
...
INSERT INTO events (seq, at, entity, event, detail) VALUES (34, '2026-07-24T13:26:03Z', '#13', 'create', 'Harden the agent push barrier; decide template propagation and credential isolation');
INSERT INTO events (seq, at, entity, event, detail) VALUES (35, '2026-07-24T13:32:34Z', '#13', 'edit', 'note: Pre-publication hardening. Done this rep…→OWNER DECISION 2026-07-24 (recorded in E…');
INSERT INTO events (seq, at, entity, event, detail) VALUES (36, '2026-07-24T13:32:43Z', '#13', 'park', 'Requested work (A) complete: push-deny lives in this repo only, no template change; (B) credential isolation remains owner-optional');
INSERT INTO events (seq, at, entity, event, detail) VALUES (37, '2026-07-24T14:21:47Z', '#14', 'create', 'History rewrite plan (variant alpha) — execute before the first public push');
INSERT INTO events (seq, at, entity, event, detail) VALUES (38, '2026-07-24T14:21:47Z', '#14', 'park', 'Executes only at the owner''s go, immediately before the first public push; not v0-blocking');
