...
INSERT INTO epic_criteria (epic, seq, criterion, met, evidence) VALUES ('v0-bootstrap', 4, 'Pilot ladder rungs 3-4: gitignored disposable-clone import rehearsal, then colocated live install (plan S12)', 0, '');
INSERT INTO epic_criteria (epic, seq, criterion, met, evidence) VALUES ('v0-bootstrap', 5, 'README, CONTRIBUTING (DCO + AI clause), generic migration guide, docs link-check (plan S12)', 0, '');
...
INSERT INTO stories (epic, id, title, status, dod, consumes, produces, blocked) VALUES ('v0-bootstrap', 'S19', 'S12 - pilot ladder and remaining deliverables', 'IN-PROGRESS', 'pilot rungs 3-4; README; CONTRIBUTING (DCO + AI clause); generic migration guide (INV-449/450 ride here); docs link-check', '', '', '');
