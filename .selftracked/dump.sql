-- selftracked dump schema_version=1 tasks=5 artifacts=0
...
INSERT INTO epic_criteria (epic, seq, criterion, met, evidence) VALUES ('v0-bootstrap', 2, '$ selftracked verify', 0, '');
...
INSERT INTO stories (epic, id, title, status, dod, consumes, produces, blocked) VALUES ('v0-bootstrap', 'S17', 'S10 - dogfood switchover', 'IN-PROGRESS', 'corpus imported through the S9 door; selftracked verify green on this repo''s live tracker; bootstrap ledger deleted; inventory file retired (git history keeps both)', '', '', '');
