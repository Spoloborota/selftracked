...
INSERT INTO epic_criteria (epic, seq, criterion, met, evidence) VALUES ('pilot-adaptation', 1, 'The documented onboarding recipe deploys selftracked end-to-end (init, hooks, import) on two consecutive fresh sandbox copies with selftracked verify green and no manual forks', 0, '');
INSERT INTO epic_criteria (epic, seq, criterion, met, evidence) VALUES ('pilot-adaptation', 2, 'Import fidelity on the sandbox copy is verified by recorded checks: no source records lost or altered', 0, '');
INSERT INTO epic_criteria (epic, seq, criterion, met, evidence) VALUES ('pilot-adaptation', 3, 'Every generic defect surfaced by the experiments is filed as a public task; every fix applied carries tests and green gates', 0, '');
...
INSERT INTO stories (epic, id, title, status, dod, consumes, produces, blocked) VALUES ('pilot-adaptation', 'S1', 'Relocation baseline: a fresh sandbox copy passes its own native checks at the new location; breakages recorded locally', 'IN-PROGRESS', '', '', '', '');
INSERT INTO stories (epic, id, title, status, dod, consumes, produces, blocked) VALUES ('pilot-adaptation', 'S2', 'Deploy recipe: init + hook colocation with the host''s existing hook chain on a fresh copy, selftracked verify green', 'PLANNED', '', '', '', '');
INSERT INTO stories (epic, id, title, status, dod, consumes, produces, blocked) VALUES ('pilot-adaptation', 'S3', 'Legacy import: the host''s existing backlog imports on the sandbox copy with recorded fidelity checks', 'PLANNED', '', '', '', '');
INSERT INTO stories (epic, id, title, status, dod, consumes, produces, blocked) VALUES ('pilot-adaptation', 'S4', 'Repeatability: the full documented recipe passes end-to-end on a fresh copy with no manual forks, twice consecutively', 'PLANNED', '', '', '', '');
