...
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (10, 'chaining recipe: a guarded chained line would survive directory-deletion abandonment', 'DONE', 'Fixed via amendment chaining-recipe-guards-abandonment (spec rev 3.24, commit b9a964f): both printed lines are existence-guarded, so deleting .selftracked/ no longer blocks the host repository''s commits with 127. All three cases (absent, RED, green) proven by hand before the change; activate_test.go pins the guarded lines; make gates green.', '', NULL, NULL, '2026-07-24T01:49:31Z', '2026-07-24T21:41:08Z');
...
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (18, 'epic show omits the linked-artifacts section (ADRs and evidence are invisible to a reader)', 'DONE', 'Fixed via amendment show-verbs-print-linked-artifacts (spec rev 3.25, commit 2613766): show <id> and epic show list linked artifacts as class[@scope]:relpath (role), archived marked, text and --json ([] when empty). link.txtar asserts it; live check: ADR 0001 now prints on this task (grounding) and on epic:v0-bootstrap (adr).', '', NULL, NULL, '2026-07-24T20:44:34Z', '2026-07-24T21:41:08Z');
