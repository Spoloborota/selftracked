-- selftracked dump schema_version=1 tasks=19 artifacts=1
...
INSERT INTO stories (epic, id, title, status, dod, consumes, produces, blocked) VALUES ('pilot-adaptation', 'S3', 'Legacy import: the host''s existing backlog imports on the sandbox copy with recorded fidelity checks', 'IN-PROGRESS', '', '', '', '');
