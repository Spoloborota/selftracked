-- selftracked dump schema_version=1 tasks=17 artifacts=0
...
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (16, 'Argument-shape guard for dump-supplied tokens reaching git argv (verify/import-dates)', 'NEEDS-TRIAGE', 'Survivor of the withdrawn hardening campaign (dropped 2026-07-24). Not dominated by the criteria code-exec surface because it is reachable from verify, which a user runs without intending to execute repo state: An argument-injection reachability from a dump-supplied token to a git argv sink; detail in the private research archive. Needs an amendment before code lands (spec 8.5/14 declare the trust boundary).', '', NULL, NULL, '2026-07-24T20:05:41Z', '2026-07-24T20:05:41Z');
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (17, 'git mv in paths move receives dictionary-supplied roots with no -- separator (CWE-88 shape)', 'NEEDS-TRIAGE', 'Survivor of the withdrawn hardening campaign. a git mv sink receiving dictionary-supplied roots; detail in the private research archive. Also: pathsMove skips the validateText check that pathsSet applies to the same column. Same governance requirement as the sibling task.', '', NULL, NULL, '2026-07-24T20:05:41Z', '2026-07-24T20:05:41Z');
