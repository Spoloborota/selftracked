...
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (11, 'Go-public audit gate: run the two-layer pre-publication audit before any public push', 'NEEDS-TRIAGE', 'Two-layer pre-publication audit to run before any public push. Protocol in the private research archive.', 'Beyond v0 scope; becomes active when the owner decides to take the repo public', NULL, NULL, '2026-07-24T12:56:09Z', '2026-07-24T14:41:11Z');
...
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (13, 'Harden the agent push barrier (this repo)', 'NEEDS-TRIAGE', 'Agent push-deny in place for this repo per owner decision; credential-isolation option left open. Detail in the private research archive.', 'Requested work (A) complete: push-deny lives in this repo only, no template change; (B) credential isolation remains owner-optional', NULL, NULL, '2026-07-24T13:26:03Z', '2026-07-24T14:42:56Z');
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (14, 'Pre-release repository hygiene pass', 'NEEDS-TRIAGE', 'Owner-gated cleanup pass to run before the first public push. Plan in the private research archive.', 'Executes only at the owner''s go, immediately before the first public push; not v0-blocking', NULL, NULL, '2026-07-24T14:21:47Z', '2026-07-24T14:41:11Z');
...
INSERT INTO events (seq, at, entity, event, detail) VALUES (40, '2026-07-24T14:41:11Z', '#11', 'edit', 'note: Publication is separate from criterion 6…→Two-layer pre-publication audit to run b…');
INSERT INTO events (seq, at, entity, event, detail) VALUES (41, '2026-07-24T14:41:11Z', '#13', 'edit', 'note: OWNER DECISION 2026-07-24 (recorded in E…→Agent push-deny in place for this repo p…');
INSERT INTO events (seq, at, entity, event, detail) VALUES (42, '2026-07-24T14:41:11Z', '#14', 'edit', 'title: History rewrite plan (variant alpha) —…→Pre-release repository hygiene pass; note: Pre-first-push history rewrite via git-f…→Owner-gated cleanup pass to run before t…');
INSERT INTO events (seq, at, entity, event, detail) VALUES (43, '2026-07-24T14:42:56Z', '#13', 'edit', 'title: Harden the agent push barrier; decide te…→Harden the agent push barrier (this repo…');
