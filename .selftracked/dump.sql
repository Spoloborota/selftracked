-- selftracked dump schema_version=1 tasks=33 artifacts=1
...
INSERT INTO tasks (id, title, status, status_note, parked, dup_of, epic, created_at, updated_at) VALUES (29, '--json silently ignored by rel add/rm/tree/cycles and paths ls', 'OPEN', 'The spec promises --json on every verb; these five accept the flag and emit plain text anyway (success path; error envelopes are fine). Breaks scripted consumption - a caller cannot rely on the documented contract. S5 blocks B and C.', '', NULL, NULL, '2026-07-25T08:53:40Z', '2026-07-25T08:53:40Z');
