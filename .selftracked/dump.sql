...
INSERT INTO epic_criteria (epic, seq, criterion, met, evidence) VALUES ('v0-bootstrap', 3, 'Schema version gate and migration branches ship (plan S11)', 0, '');
...
INSERT INTO stories (epic, id, title, status, dod, consumes, produces, blocked) VALUES ('v0-bootstrap', 'S18', 'S11 - version gate and migration branches', 'IN-PROGRESS', 'schema version gate + migration branches per plan section 4 S11; INV-464 migrated field rides here', '', '', '');
